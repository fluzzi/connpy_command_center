...
const CopilotPhantomInput: React.FC<CopilotPhantomInputProps> = ({
  ...
  return (
    <div className="w-full bg-[#2e3440] border-t border-[#3b4252] z-[100] animate-in slide-in-from-bottom-2 duration-200">
      ...
      <div className="flex items-center justify-center py-3 px-8 overflow-x-auto scrollbar-hide bg-[#3b4252] shadow-sm z-10">
        <div 
          style={{ marginRight: '3px', paddingLeft: '2px', paddingRight: '2px' }}
          className={clsx(
            "py-1.5 rounded-md text-[11px] font-black uppercase tracking-widest flex items-center gap-2 border transition-all shrink-0",
            persona === 'architect' 
        ...
        <div 
          style={{ marginRight: '3px', paddingLeft: '2px', paddingRight: '2px' }}
          className={clsx(
            "py-1.5 rounded-md text-[11px] font-black uppercase tracking-widest flex items-center gap-2 border transition-all shrink-0 bg-[#81a1c1]/10 border-[#81a1c1]/30 text-[#81a1c1]",
        ...
        <div 
          style={{ marginRight: '3px', paddingLeft: '2px', paddingRight: '2px' }}
          className="py-1.5 rounded-md bg-[#81a1c1]/10 border border-[#81a1c1]/30 text-[#81a1c1] text-[11px] font-black tracking-widest flex items-center gap-2 shrink-0"
        >
        ...
        {contextDetail && (
          <button
            ...
            className="py-1.5 px-3 rounded-md bg-[#ebcb8b]/10 border border-[#ebcb8b]/30 text-[#ebcb8b] text-[11px] font-black flex items-center gap-2 shrink-0 truncate max-w-[500px] hover:bg-[#ebcb8b]/20 transition-all active:scale-95"
